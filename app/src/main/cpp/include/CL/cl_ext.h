...
/* CL_DEVICE_DOUBLE_FP_CONFIG is defined in include.CL.h for OpenCL >= 120 */
 ...
 *
 * The application may not call include.CL api's with the cl_mem object passed to the pfn_notify.
 *
...
/* For OpenCL 2.1 and newer, cl_kernel_sub_group_info is declared in include.CL.h.
